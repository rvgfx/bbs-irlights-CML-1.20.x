...
- ПРЕДСКАЗАННАЯ ПОТЕРЯ СЛУЧИЛАСЬ (обнаружено 2026-07-02): outline-реворк-коммиты на master аддона (147b23f Complementary, 0ccb11a Bliss, d66f422 BSL, 510891a Solas) регенерировали патчи из отставших Shadres-копий и СТЁРЛИ cookie-ops, добавленные d759820. Сейчас cookie есть ТОЛЬКО в patches/photon.irlights; 4 патча стride-битые (GLSL 5 vec4 = 80Б vs Java 96Б) — у пропатченных ими *_IRLights паков свет со 2-го источника читается мусором. Частичный фикс 2026-07-02: в Shadres/Modification/ComplementaryReimagined struct дополнен vec4 cookie (только страйд-паритет, БЕЗ irlite_cookie()-сэмплинга) по ходу задачи VL-noise. Полное восстановление (cookie-ops в 4 патча + сэмплинг-GLSL в Modification-копии) — чип-задача.
