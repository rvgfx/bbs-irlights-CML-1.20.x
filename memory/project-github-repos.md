...
IterationRP убран + ИСТОРИЯ ВЫЧИЩЕНА для публикации (2026-06-20): IterationRP — приватный/платный шейдерпак (Tahnass). По решению юзера интеграция БЫЛА убрана до разрешения автора; файлы оставлены локально (gitignored, НЕ удалены). РАЗРЕШЕНИЕ ПОЛУЧЕНО 2026-07-09: автор Tahnass согласовал ПУБЛИЧНЫЙ патч для своих шейдеров -> имеем право создавать и коммитить/публиковать патч IterationRP. Публикуется ТОЛЬКО наш патч (anchor-based .irlights + генератор), НЕ исходники пака (Shadres/ остаётся gitignored). Патч+генератор аддона уже расижнорены (см. ниже).
- БЫЛО делистнуто из всех 6 README; было untracked + в .gitignore (маркер # IterationRP integration): аддон patches/iterationrp.irlights + tools/gen-iterationrp-patch.ps1; редактор src/client/resources/assets/irl-redactor/patches/iterationrp.irlights. РАЗИГНОР 2026-07-09: в аддоне убран .gitignore-блок (был L133-135) -> patches/iterationrp.irlights + tools/gen-iterationrp-patch.ps1 снова untracked и коммитабельны (в ряду с 6 остальными паками). СДЕЛАНО 2026-07-09 в camera-relative-сессии (рабочее дерево редактора, не закоммичено): расижнор editor .gitignore (был блок L29-30), iterationrp.irlights скопирован copy-patches'ом (untracked new), editor main README релистнул IterationRP† + Rethinking Voxels. ОСТАЛОСЬ: git-коммит + релист на остальных ветках/README по мере.
